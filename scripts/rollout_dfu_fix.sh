...
#   4 boards -> 0.2.3 (global VERSION), T10 -> 0.3.4 (board-scoped).
set -uo pipefail
...
declare -A VER=( [AF-F4_nano]=0.2.3 [AF-F7_mini]=0.2.3 [AF-H7_nano]=0.2.3 [AF-H7E]=0.2.3 [AF-F4_T10_nano]=0.3.4 )
